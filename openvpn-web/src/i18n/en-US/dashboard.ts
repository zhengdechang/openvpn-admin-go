const translation = {
  ...
  users: {
    ...
    statsTotalUsersHint: "{{count}} accounts provisioned",
    statsOnline: "Online Users",
    statsOnlineHint: "{{count}} currently connected",
    statsPaused: "Paused Users",
    statsPausedHint: "{{count}} blocked",
    statsTraffic: "Aggregate Traffic",
    statsTrafficHint: "Combined upload & download",
    ...
    filterDepartmentNone: "No department",
    statusFilterLabel: "Connection state",
    filterStatusAll: "All states",
    filterStatusOnline: "Online",
    filterStatusOffline: "Offline",
    ...
    rejectConfirm: "Reject this user's registration?",
    ...
    resultsSummary: "Showing {{count}} of {{total}} users",
  },
  notifications: {
  ...
  overview: {
    ...
    labelLastUpdated: "Last Updated",
    noData: "No data available",
    unavailable: "No status information to display",
    // Deployment system status
    sysCardTitle: "System",
    cpuCardTitle: "CPU",
    memCardTitle: "Memory",
    storageCardTitle: "Storage",
    labelVersion: "Service Version",
    labelHostname: "Hostname",
    labelArch: "Architecture",
    labelKernel: "Kernel Version",
    labelGoVersion: "Go Version",
    labelLocalTime: "Local Time",
    labelHostUptime: "Uptime",
    labelLoadAvg: "Load Average",
    labelCpuCores: "CPU Cores",
    labelCpuUsage: "Used",
    labelMemUsed: "Used",
    labelMemBuffers: "Buffered",
    labelMemCached: "Cached",
    labelSwap: "Swap",
    labelDisk: "Disk",
  },
};
